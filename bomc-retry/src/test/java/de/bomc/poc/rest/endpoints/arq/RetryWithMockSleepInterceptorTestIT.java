...
public class RetryWithMockSleepInterceptorTestIT extends ArquillianBase {
	private static final String LOG_PREFIX = "RetryWithMockSleepInterceptorTestIT#";
	...
	public static Archive<?> createDeployment() {
		...
		webArchive.addClass(RetryWithMockSleepInterceptorTestIT.class);
		...
		webArchive.addClasses(MockSleepInterceptor.class);
	...
	/**
	 * <pre>
	 *  mvn clean install -Parq-wildfly-remote -Dtest=RetryWithMockSleepInterceptorTestIT#test010_retry_seq_Pass
	 * </pre>
	 */
	@Test
	@InSequence(10)
	...
	/**
	 * <pre>
	 *  mvn clean install -Parq-wildfly-remote -Dtest=RetryWithMockSleepInterceptorTestIT#test020_retry_parallel_Pass
	 * </pre>
	 */
	@Test
	@InSequence(20)
