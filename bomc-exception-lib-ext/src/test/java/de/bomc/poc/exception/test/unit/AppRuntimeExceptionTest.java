...
public class AppRuntimeExceptionTest {
	...
	public void test020_createAppRuntimeExceptionWithMessage_Pass() {
		...
		try {
			final AppRuntimeException appRuntimeException = new AppRuntimeException(MESSAGE,
	...
	public void test030_createAppRuntimeExceptionWithThrowable_Pass() {
		...
		try {
			...
			assertThat(sRE.getErrorCode(), is(equalTo(BasisErrorCodeEnum.CONNECTION_FAILURE_10500)));
	...
	public void test070_stackTraceWithRootCauseNull_Pass() {
		...
		try {
			...
			final AppRuntimeException s1 = new AppRuntimeException(s0, BasisErrorCodeEnum.UNEXPECTED_10000);
	...
	public void test090_wrapThrowableWithErrorCode_Pass() {
		...
		try {
			...
			final AppRuntimeException appRuntimeException = AppRuntimeException.wrap(nPE, BasisErrorCodeEnum.UNEXPECTED_10000);

			assertThat(appRuntimeException.getCause(), is(instanceOf(NullPointerException.class)));
			assertThat(appRuntimeException.getErrorCode(), is(equalTo(BasisErrorCodeEnum.UNEXPECTED_10000)));
		}
	}
	...
	public void test100_wrapThrowableThatOverwritesCatchedErrorCode_Pass() {
		...
		try {
			...
			final AppRuntimeException appRuntimeException = AppRuntimeException.wrap(sRE, BasisErrorCodeEnum.CONNECTION_FAILURE_10500);

			assertThat(appRuntimeException.getCause(), is(instanceOf(ArithmeticException.class)));
			assertThat(appRuntimeException.getErrorCode(), is(equalTo(BasisErrorCodeEnum.CONNECTION_FAILURE_10500)));
		}
	}
	...
	public void test120_wrapAppRuntimeExceptionWithErrorCode_Pass() {
		...
		try {
			...
			final AppRuntimeException appRuntimeException = AppRuntimeException.wrap(nPE, BasisErrorCodeEnum.CONNECTION_FAILURE_10500);
	...
	public void test130_wrapsAppRuntimeExceptionInAppRuntimeExceptionWithErrorCode_Pass() {
		...
		try {
			...
			LOGGER.debug(LOG_PREFIX + "test130_wrapsAppRuntimeExceptionInAppRuntimeExceptionWithErrorCode_Pass - "
					+ appRuntimeException.stackTraceToString());
		}
	}
	...
	/**
	 * A helper method that throws a <code>AppRuntimeException</code>. The
	...
	private void helperMethodCreatesAppRuntimeExceptionWithErrorCodeNull() {
		try {
			...
			appRuntimeException.set("name1", "value1").set("name2", "value2");
			throw appRuntimeException;
		}
	}
	...
	private void helperMethodCreatesAppRuntimeExceptionWithErrorCode() {
		try {
			...
			final AppRuntimeException appRuntimeException = new AppRuntimeException(ex, null);
			appRuntimeException.set("name1", "value1").set("name2", "value2");
			appRuntimeException.setErrorCode(BasisErrorCodeEnum.CONNECTION_FAILURE_10500);
	...
	private void helperMethodCreatesAppRuntimeExceptionWithMessageThrowableErrorCode() {
		try {
			...
			final AppRuntimeException appRuntimeException = new AppRuntimeException(ERROR_MESSAGE, ex,
