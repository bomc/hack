...
import de.bomc.poc.test.auth.arq.usermanagement.UsermanagementRestEndpointV1TestIT;
 ...
 */
public class EnvConfigFilterMockProducer {
		...
		if (annotation != null) {
			...
			if (key != null) {
				...
				case ZNODE_BASE_PATH:
					return "/" + UsermanagementRestEndpointV1TestIT.WEB_ARCHIVE_NAME + GlobalArqTestProperties.RELATIVE_ROOT_Z_NODE;
				}
			}
		}
