...
public class RequestObjectDtoTest {

    private static final String LOG_PREFIX = "api#test#request#RequestObjectDtoTest#";
    @Rule
    public final ExpectedException thrown = ExpectedException.none();

    @Test
    public void test01_createRequestObjectDto() {
        System.out.println(LOG_PREFIX + "test01_createRequestObjectDto");

        final RequestObjectDTO dto = RequestObjectDTO.with(new Parameter("param1", new LongType(2l)));
    ...
    public void test02_jaxbList() throws Exception {
        ...
        final RequestObjectDTO dto = RequestObjectDTO.with(p1)
                                                     .and(p2)
                                                     .and(p3)
                                                     .and(p4)
                                                     .and(p5);

        final JAXBContext context = JAXBContext.newInstance(RequestObjectDTO.class, Parameter.class, AbstractType.class, BooleanType.class, DoubleType.class, IntegerType.class, LongType.class, StringType.class,
        ...
        final RequestObjectDTO dtoUnmarshall = (RequestObjectDTO)unmarshaller.unmarshal(new File("target/x.xml"));
    ...
    public void test04_equalsHashcode() {
        ...
        final Set<RequestObjectDTO> set = new HashSet<>();
        ...
        final RequestObjectDTO dto1 = RequestObjectDTO.with(p11)
                                                      .and(p21)
                                                      .and(p31)
                                                      .and(p41)
                                                      .and(p51);
