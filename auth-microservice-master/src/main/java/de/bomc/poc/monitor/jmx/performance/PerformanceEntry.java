...
public class PerformanceEntry {
	 ...
	 * 
	 * @param time
	 *            the measured time for method invocation.
	 * @param successType
	 *            value for method is finished successful.
	 */
	...
	/**
	 * @return the size for notification. If size is larger than null,
	 ...
	 * Codes:
	 * 
	 * TODO: Success: - Business exception: O Any other, usually technical
	 * exception: X
	 * 
	 * @return String
	 */
	...
	/**
	 * @param limitInPercent
	 *            the limitInPercent to set
	 */
	...
	public String toString() {
		return "Entry [service=" + this.service + ", method=" + this.method + ", avg=" + this.getAverage()
				+ ", invocationCounter=" + this.invocationCounter + ", min=" + this.min + ", max=" + this.max
				+ " , sum=" + this.sum + ", callsQueue=" + this.callsQueue + ", callsBufferLength=" + CALLS_BUFFER_LENGTH
				+ ", isMonitoringEnabled=" + this.isMonitoringEnabled + ", limitInPercent=" + this.limitInPercent
				+ ", notifyDataQueue.size=" + this.notifyDataQueue.size() + "]";
	}
}