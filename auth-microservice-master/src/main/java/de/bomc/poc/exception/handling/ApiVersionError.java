 ...
 */
public enum ApiVersionError implements ApiError {
	...
	/**
	 * Creates a new instance of <code>ApiVersionError</code>.
	 * 
	 * @param status
	 *            the rest status.
	 * @param messageKey
	 ...
	 */
	ApiVersionError(final Response.Status status, final String messageKey) {
		this.status = status;
