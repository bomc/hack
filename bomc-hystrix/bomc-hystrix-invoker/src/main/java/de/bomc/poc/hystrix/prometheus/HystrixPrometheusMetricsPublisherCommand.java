...
/**
 * Implementation of a {@link HystrixMetricsPublisherCommand} for Prometheus
 * Metrics. See <a href=
...
public class HystrixPrometheusMetricsPublisherCommand implements HystrixMetricsPublisherCommand {
	...
	public HystrixPrometheusMetricsPublisherCommand(HystrixMetricsCollector collector, HystrixCommandKey commandKey,
	...
	public void initialize() {
		...
		if (exportProperties) {
			String propDesc = "These informational metrics report the "
					...
					+ "see when a dynamic property takes effect and confirm a property is set as " + "expected.";
