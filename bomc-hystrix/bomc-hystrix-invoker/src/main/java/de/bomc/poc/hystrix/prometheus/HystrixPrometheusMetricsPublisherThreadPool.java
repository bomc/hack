...
/**
 * Implementation of a {@link HystrixMetricsPublisherThreadPool} for Prometheus
 * Metrics. See <a href=
 * "https://github.com/Netflix/Hystrix/wiki/Metrics-and-Monitoring">Hystrix
 * Metrics and Monitoring</a>.
 */
public class HystrixPrometheusMetricsPublisherThreadPool implements HystrixMetricsPublisherThreadPool {
	...
	public HystrixPrometheusMetricsPublisherThreadPool(HystrixMetricsCollector collector, HystrixThreadPoolKey key,
			HystrixThreadPoolMetrics metrics, HystrixThreadPoolProperties properties, boolean exportProperties) {
