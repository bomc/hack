...
public class SwaggerListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		beanConfig.setTitle("Kafka microservices REST API");
		...
		beanConfig.setResourcePackage("de.bomc.poc");
		...
		beanConfig.setBasePath("/kafka-poc/bomc-app");
