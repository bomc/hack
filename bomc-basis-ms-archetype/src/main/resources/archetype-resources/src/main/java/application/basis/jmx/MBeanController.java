...
public class MBeanController {
    ...
    private static final String LOG_PREFIX = "MBeanController${symbol_pound}";
    ...
    public ObjectName makeObjectName(String path, MBeanInfo mBeanInfo) throws MalformedObjectNameException {
        ...
        try {
            ...
            final String errMsg =
                LOG_PREFIX + "makeObjectName - invalid name ${symbol_escape}"" + beanName.toString() + "${symbol_escape}" for class "
