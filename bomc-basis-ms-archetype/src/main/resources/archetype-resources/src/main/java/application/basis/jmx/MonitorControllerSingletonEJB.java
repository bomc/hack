...
public class MonitorControllerSingletonEJB {
    ...
    private static final String LOG_PREFIX = "MonitorControllerSingletonEJB${symbol_pound}";
    ...
    public void init() {
        ...
        try {
            ...
            // GaugeMonitor.
            this.gaugeMonitorList.add(this.getGaugeMonitor(THRESHOLD_HEAP_HIGH, THRESHOLD_HEAP_LOW, jvmMetricsObjectName, "JvmHeapMetrics", "HeapMemoryUsage"));
            this.gaugeMonitorList.add(this.getGaugeMonitor(THRESHOLD_NON_HEAP_HIGH, THRESHOLD_NON_HEAP_LOW, jvmMetricsObjectName, "JvmNonHeapMetrics", "NonHeapMemoryUsage"));

            //
            // Register a monitor, check peaks in activity, use JMX's
            // GaugeMonitor.
            this.gaugeMonitorList.add(this.getGaugeMonitor(THRESHOLD_PROCESS_HIGH, THRESHOLD_PROCESS_LOW, jvmMetricsObjectName, "JvmProcessCpuLoadMetrics", "ProcessCpuLoad"));
            this.gaugeMonitorList.add(this.getGaugeMonitor(THRESHOLD_SYSTEM_HIGH, THRESHOLD_SYSTEM_LOW, jvmMetricsObjectName, "JvmSystemCpuLoadMetrics", "SystemCpuLoad"));
            ...
            throw new AppRuntimeException(LOG_PREFIX + "init - failed! ", AppErrorCodeEnum.APP_INITILIZATION_START_COMPONENT_FAILURE_10600);
        }
    }
