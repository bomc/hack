...
public class ApiOverviewRestEndpointTestIT extends ArquillianBase {
    ...
    private static final String LOG_PREFIX = "ApiOverviewRestEndpointTestIT${symbol_pound}";
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=ApiOverviewRestEndpointTestIT${symbol_pound}test010_v1_overview_pass
     *
