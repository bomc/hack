...
public class VersionRestEndpointFailTestIT extends ArquillianBase {
    ...
    private static final String LOG_PREFIX = "VersionRestEndpointFailTestIT${symbol_pound}";
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=VersionRestEndpointFailTestIT${symbol_pound}test010_v1_readVersion_Fail
     *
