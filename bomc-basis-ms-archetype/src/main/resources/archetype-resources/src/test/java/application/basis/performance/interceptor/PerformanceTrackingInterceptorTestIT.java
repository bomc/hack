...
import ${package}.application.basis.jmx.JmxGaugeMonitor;
import ${package}.application.basis.jmx.MBeanController;
import ${package}.application.basis.jmx.MBeanInfo;
import ${package}.application.basis.jmx.MonitorControllerSingletonEJB;
import ${package}.application.basis.jmx.RootName;
import ${package}.application.basis.jmx.RootNameMBean;
import ${package}.application.basis.jmx.ThresholdNotificationListener;
...
public class PerformanceTrackingInterceptorTestIT extends ArquillianBase {
    ...
    private static final String LOG_PREFIX = "PerformanceTrackingInterceptorTestIT${symbol_pound}";
    @Inject
    @LoggerQualifier
    ...
    public static Archive<?> createDeployment() {
        ...
        System.out.println("PerformanceTrackingInterceptorTestIT${symbol_pound}createDeployment: " + webArchive.toString(true));
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=PerformanceTrackingInterceptorTestIT${symbol_pound}test010_performanceTrackingWithAppRuntimeException_fail
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=PerformanceTrackingInterceptorTestIT${symbol_pound}test020_performanceTrackingWithIllegalArgumentException_fail
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=PerformanceTrackingInterceptorTestIT${symbol_pound}test030_performanceTrackingWithAppRuntimeExIsLogged_fail
     *
