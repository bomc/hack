...
public class JvmMetricsFastTest {
    ...
    private static final String LOG_PREFIX = "JvmMetricsFastTest${symbol_pound}";
    ...
    public void test030_registerMBeanToParentMBean_pass() throws Exception {
        ...
        try {
            ...
            assertThat(setObjNames.contains(new ObjectName("${package}.${artifactId}:name0=Microservice,name1=JvmMetrics")), equalTo(true));
    ...
    private void tearDown() {
        ...
        try {
            ...
            LOGGER.debug(LOG_PREFIX + "${symbol_pound}tearDown - Unexpected, ignoring!" + e);
        }
        // Help GC.
