...
public interface PerformanceRestEndpoint {
    ...
    @ApiResponses({ @ApiResponse(code = 404, message = "Endpoint not found."),
            @ApiResponse(code = 200, message = "The performance metric by worst average as response object that wraps the javax.json.JsonObject as a string.") })
    @GET
    ...
    @ApiResponses({ @ApiResponse(code = 404, message = "Endpoint not found."),
            @ApiResponse(code = 200, message = "The performance metric by worst count as response object that wraps the javax.json.JsonObject as a string.") })
    @GET
    @Path("/worst-by-count")
    ...
    @ApiResponses({ @ApiResponse(code = 404, message = "Endpoint not found."),
            @ApiResponse(code = 200, message = "The performance metric by worst time as response object that wraps the javax.json.JsonObject as a string.") })
    @GET
    @Path("/worst-by-time")
