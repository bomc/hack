 ...
 * </pre>
 */
package de.bomc.poc.order.interfaces.rest.v1.basis;
...
public interface ExceptionLogRestEndpoint {
    ...
    /**
     * <pre>
     *  http://127.0.0.1:8180/bomc-order/rest/exceptions/stored
     *  curl -v -H "Accept: application/vnd.exception-v1+json" -H "Content-Type: application/vnd.exception-v1+json" -H "X-BOMC-REQUEST-ID: SET-BY-CURL-123" -H "X-BOMC-AUTHORIZATION: BOMC_USER" -X GET "127.0.0.1:8180/bomc-order/rest/exception/stored"
     * </pre>
     */
    ...
    @GET
    @Path("/stored")
    @Produces({ ExceptionLogRestEndpoint.MEDIA_TYPE_JSON_V1 })
    Response getStoredExceptions(@HeaderParam(value = "X-BOMC_USER_ID") @ApiParam(value = "The userId of the exceuted user.") final String userId);
}