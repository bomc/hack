 ...
 * </pre>
 */
package de.bomc.poc.order.application.basis.version;
...
public class VersionSingletonEJB {
    ...
    public String readVersionFromClasspath() throws IOException {
        ...
        try {
            ...
            final AppRuntimeException appRuntimeException = new AppRuntimeException(errMsg, exception,
                    AppErrorCodeEnum.APP_READ_VERSION_FAILED_10602);
