...
public class PerformanceTrackingInterceptor implements Serializable {
    ...
    public Object logMethodEntry(final InvocationContext invocationContext) throws Exception {
        this.logger.trace(LOG_PREFIX + "logMethodEntry");
        ...
        try {
            ...
            performanceTracking.track(invocationContext.getMethod().getDeclaringClass().getCanonicalName(),
                    invocationContext.getMethod().getName(), duration, "success_" + this.getCurrentTime());
    ...
    private String getCurrentTime() {
        this.logger.trace(LOG_PREFIX + "getCurrentTime");
