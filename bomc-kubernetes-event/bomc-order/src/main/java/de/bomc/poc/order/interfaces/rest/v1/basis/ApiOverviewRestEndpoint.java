...
public interface ApiOverviewRestEndpoint {
    ...
    /**
     * <pre>
     *  http://127.0.0.1:8180/bomc-order/rest/overview/endpoints
     ...
     * "127.0.0.1:8180/bomc-order/rest/overview/endpoints"
     * </pre>
     */
    ...
    @ApiResponses({ @ApiResponse(code = 404, message = "Endpoint not found."),
            @ApiResponse(code = 200, message = "Response object as string that wraps the javax.json.JsonObject.") })
    @GET
    @Path("/endpoints")
