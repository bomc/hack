...
public class VersionRestEndpointTestIT extends ArquillianBase {
    ...
    private static final String LOG_PREFIX = "VersionRestEndpointTestIT#";
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=VersionRestEndpointTestIT#test010_v1_readVersion_Pass
     *
