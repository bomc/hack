...
import de.bomc.poc.order.application.basis.jmx.performance.PerformanceEntryNotifyData;
...
public class PerformanceRestEndpointTestIT extends ArquillianBase {
    ...
    private static final String LOG_PREFIX = "PerformanceRestEndpointTestIT#";
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=PerformanceRestEndpointTestIT#test010_v1_readEmpty_Pass
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=PerformanceRestEndpointTestIT#test020_v1_readWorstByAverage_pass
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=PerformanceRestEndpointTestIT#test030_v1_readWorstByCount_pass
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=PerformanceRestEndpointTestIT#test040_v1_readWorstByTime_pass
     *
