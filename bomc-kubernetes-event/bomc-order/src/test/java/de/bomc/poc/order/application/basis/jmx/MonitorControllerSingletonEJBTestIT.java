...
import de.bomc.poc.order.application.basis.jmx.metrics.JvmMetricsMBean;
...
import de.bomc.poc.order.application.basis.performance.interceptor.PerformanceTrackingInterceptor;
...
public class MonitorControllerSingletonEJBTestIT extends ArquillianBase {
    ...
    private static final String LOG_PREFIX = "MonitorControllerSingletonEJBTestIT#";
    @Inject
    @LoggerQualifier
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=MonitorControllerSingletonEJBTestIT#test010_registerMBeans_Pass
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=MonitorControllerSingletonEJBTestIT#test020_thresholdEvent_Pass
     *
