...
import de.bomc.poc.order.domain.model.basis.log.ExceptionLogEntity;
import de.bomc.poc.order.domain.model.basis.log.JpaExceptionLogDao;
...
import de.bomc.poc.order.infrastructure.persistence.basis.log.JpaExceptionLogDaoImpl;
...
public class JpaDaoTestIT extends ArquillianBase {
    ...
    public static Archive<?> createDeployment() {
        ...
        // Add initial data.
        webArchive.addAsResource("test.scripts/exception_log_import.sql", "import.sql");
    ...
    public void test999_againstEmptyDb_fail() throws Exception {
        ...
        final LocalDateTime localDateTime = LocalDateTime.of(LocalDate.of(2018, 11, 29), LocalTime.now());
        this.jpaExceptionLogDao.deleteEntriesFromSpecifiedDateTime(localDateTime);
