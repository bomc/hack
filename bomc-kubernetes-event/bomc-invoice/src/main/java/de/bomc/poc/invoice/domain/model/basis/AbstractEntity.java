...
public abstract class AbstractEntity<T> extends AbstractMetadataEntity {
    ...
    public void setId(final Long id) {
        LOGGER.log(Level.FINE, LOG_PREFIX + this.getEntityClass().getSimpleName() + "#setId [id=" + id + "]");
    ...
    public boolean isNew() {
    	LOGGER.log(Level.FINE, LOG_PREFIX + this.getEntityClass().getSimpleName() + "#isNew [isNew=" + (this.id == null) + "]");
