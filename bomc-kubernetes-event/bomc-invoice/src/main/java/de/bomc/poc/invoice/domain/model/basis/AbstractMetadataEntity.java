 ...
 * </pre>
 */
package de.bomc.poc.invoice.domain.model.basis;
...
public abstract class AbstractMetadataEntity implements DomainObject {
     ...
     * The logger.
     */
    private static final Logger LOGGER = Logger.getLogger(AbstractMetadataEntity.class.getName());
    /**
     * A log prefix.
     */
    ...
    public void prePersist() {
        LOGGER.log(Level.FINE, LOG_PREFIX + "prePersist");
    ...
    public void preUpdate() {
    	LOGGER.log(Level.FINE, LOG_PREFIX + "preUpdate");
    ...
    public Long getVersion() {
    	LOGGER.log(Level.FINE, LOG_PREFIX + "getVersion [version=" + this.version + "]");
    ...
    public void setVersion(final Long version) {
    	LOGGER.log(Level.FINE, LOG_PREFIX + "setVersion [version=" + version + "]");
