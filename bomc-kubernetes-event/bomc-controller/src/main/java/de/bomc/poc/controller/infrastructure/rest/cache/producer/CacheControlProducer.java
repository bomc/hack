 ...
 * </pre>
 */
package de.bomc.poc.controller.infrastructure.rest.cache.producer;

import javax.enterprise.inject.Produces;
import javax.enterprise.inject.spi.InjectionPoint;
import javax.ws.rs.core.CacheControl;

import de.bomc.poc.controller.infrastructure.rest.cache.qualifier.CacheControlConfigQualifier;
...
public class CacheControlProducer {
    ...
    public CacheControl get(final InjectionPoint ip) {
        ...
        CacheControlConfigQualifier cacheControlConfig = ip.getAnnotated()
