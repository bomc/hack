 ...
 * </pre>
 */
package de.bomc.poc.controller.infrastructure.persistence.basis;
...
import de.bomc.poc.controller.application.internal.ApplicationUserEnum;
import de.bomc.poc.controller.domain.model.basis.log.ExceptionLogEntity;
import de.bomc.poc.controller.domain.model.basis.log.JpaExceptionLogDao;
import de.bomc.poc.controller.domain.model.basis.AbstractEntity;
import de.bomc.poc.controller.domain.model.basis.AbstractMetadataEntity;
import de.bomc.poc.controller.domain.model.basis.DomainObject;
import de.bomc.poc.controller.infrastructure.persistence.basis.impl.AbstractJpaDao;
import de.bomc.poc.controller.infrastructure.persistence.basis.producer.DatabaseProducer;
import de.bomc.poc.controller.infrastructure.persistence.basis.qualifier.JpaDao;
import de.bomc.poc.controller.infrastructure.persistence.basis.log.JpaExceptionLogDaoImpl;
...
public class JpaDaoTestIT extends ArquillianBase {
    ...
    private static final String LOG_PREFIX = "JpaDaoTestIT#";
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=JpaDaoTestIT#test010_findRange_pass
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=JpaDaoTestIT#test020_findAll_pass
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=JpaDaoTestIT#test030_merge_pass
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=JpaDaoTestIT#test040_findByPositionalParameters_pass
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=JpaDaoTestIT#test040_findByPositionalParameters_failed
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=JpaDaoTestIT#test060_findByNamedParameters_pass
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=JpaDaoTestIT#test070_remove_pass
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=JpaDaoTestIT#test080_clearCache_fail
     *
    ...
    /**
     * <pre>
     *  mvn clean install -Parq-wildfly-remote -Dtest=JpaDaoTestIT#test999_againstEmptyDb_fail
     *
