...
public class PerformanceTrackingMBeanTest {
	...
	public void test030_registerMBeanToParentMBean_pass() throws Exception {
		...
		try {
			...
			assertThat(setObjNames.contains(new ObjectName("de.bomc.poc.controller.bomc-controller:name0=Microservice")), equalTo(true));
			assertThat(setObjNames.contains(new ObjectName("de.bomc.poc.controller.bomc-controller:name0=Microservice,name1=PerformanceTracking")),
					equalTo(true));
	...
	public class TestNotificationListener implements NotificationListener {
		...
		public void handleNotification(Notification notification, Object handback) {
			...
			System.out.println(LOG_PREFIX
					+ "test040_perfomanceTrackingMBean_pass#handleNotification - [performanceEntryNotifyData="
