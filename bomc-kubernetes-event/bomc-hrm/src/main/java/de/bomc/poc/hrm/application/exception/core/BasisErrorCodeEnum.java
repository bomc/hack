...
/**
 * The root class for error codes. Other class must derive from this class to
...
public enum BasisErrorCodeEnum implements ErrorCode {
	...
	private final static Logger LOGGER = LoggerFactory.getLogger(BasisErrorCodeEnum.class);
	//
