...
==== Request structure
include::{snippets}/user-controller-test/test015_create-user_fail/request-fields.adoc[]

==== Example Request
include::{snippets}/user-controller-test/test015_create-user_fail/http-request.adoc[]

==== CURL sample
include::{snippets}/user-controller-test/test015_create-user_fail/curl-request.adoc[]
