...
public class ArquillianBase {
	 ...
	 */
	protected static WebArchive createTestArchiveWithH2Db(final String archiveName, final String hbm2ddlValue) {
		final WebArchive webArchive = ShrinkWrap.create(WebArchive.class, archiveName + ".war")
				...
				.addAsResource(getH2PersistenceXml(hbm2ddlValue), "META-INF/persistence.xml");
		return webArchive;
	}

	/**
	 * Returns a persistence.xml instance as string.
	 * 
	 * @param hbm2ddlValue
	 *            the configurable hbm2ddl value in the persistence.xml (create-drop, none).
	 * @return a persistence.xml as string.
	 */
	public static StringAsset getH2PersistenceXml(final String hbm2ddlValue) {
		return new StringAsset("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + "<persistence version=\"2.1\"\n"
				+ "   xmlns=\"http://xmlns.jcp.org/xml/ns/persistence\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n"
				+ "   xsi:schemaLocation=\"\n" + "        http://xmlns.jcp.org/xml/ns/persistence\n"
				+ "        http://xmlns.jcp.org/xml/ns/persistence/persistence_2_1.xsd\">\n"
				+ "   <persistence-unit name=\"poc-core-pu\">\n"
