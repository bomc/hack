...
public class OrderFiledEvent {
	...
	private static final String LOG_PREFIX = "OrderFiledEvent#";
	private String orderId;
	private ProductInfo productInfo;

	public OrderFiledEvent() {
		// Used by CDI.
	}
	 ...
	 * @param productInfo
	 */
	public OrderFiledEvent(final String orderId, final ProductInfo productInfo) {
	...
	public boolean equals(Object obj) {
		...
		final OrderFiledEvent other = (OrderFiledEvent) obj;
	...
	public String toString() {
		return "OrderFiledEvent [orderId=" + this.orderId + ", productInfo=" + this.productInfo + "]";
	}
}
