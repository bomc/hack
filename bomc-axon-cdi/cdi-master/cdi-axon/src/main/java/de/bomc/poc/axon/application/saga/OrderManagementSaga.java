...
public class OrderManagementSaga {
	...
	private static final Logger LOGGER = Logger.getLogger(OrderManagementSaga.class.getSimpleName());
	...
	public void on(final OrderFiledEvent event) {
		LOGGER.info(LOG_PREFIX + "on - STARTING SAGA - [orderId=" + event.getOrderId() + "]");

		this.orderId = event.getOrderId();
		this.productInfo = event.getProductInfo();

		// Create a shipment id and start a 'PrepareShipmentCommand'.
	...
	private static class OrderProcessing {
		...
		public boolean isDone() {
			LOGGER.debug(LOG_PREFIX + "#OrderProcessing#isDone - [shipmentProcessed=" + this.shipmentProcessed
	...
	private static class OrderCompensationProcessing {
		...
		public boolean isCompensated() {
			LOGGER.debug(LOG_PREFIX + "#OrderProcessing#isCompensated - [shipmentCompensated="
