...
import de.bomc.poc.axon.infrastructure.events.order.OrderCreateCommand;
...
@Produces("text/plain")
public class OrderControllerServiceEndpoint {

	private static final Logger LOGGER = Logger.getLogger(MethodHandles.lookup().lookupClass().getName());
	private static final String LOG_PREFIX = "OrderControllerEndpoint#";
	public static final String FAIL_FLAG_SHIPMENT = "failShipment";
	public static final String DELAY_FLAG_SHIPMENT = "delayShipment";
	public static final String REGULAR_FLAG = "testShipment";
	public static final String DELAY_FLAG_INVOICE = "delayInvoice";
	public static final String FAIL_FLAG_INVOICE = "failInvoice";
	@Inject
	...
	public String createOrder(@PathParam("productId") String productId) {
		...
		final OrderCreateCommand fileOrderCommand = new OrderCreateCommand(orderId, productInfo);
