...
/**
 * Create a shipment in shipment-service.
 * 
 * @author <a href="mailto:bomc@bomc.org">Michael Börner</a>
 * @version $Revision: $ $Author: $ $Date: $
 * @since 23.10.2018
 */
public class ShipmentHystrixCommand extends AbstractHystrixCommand<ShipmentHystrixResult> {

	private static final Logger LOGGER = Logger.getLogger(MethodHandles.lookup().lookupClass().getName());
	private static final String LOG_PREFIX = "ShipmentHystrixCommand#";
	private static final String SERVICE_NAME = "lra-shipment";
	private static final String BASE_URL = "http://127.0.0.1:8180/%s";
	private static final String API_PATH = "/rest/api/compute/";
	private String option;

	/**
	 * Creates a new instance of <code>ShipmentHytrixCommand</code>.
	 * 
	 */
	public ShipmentHystrixCommand() {
	...
	protected ShipmentHystrixResult run() throws Exception {
		...
		LOGGER.info(LOG_PREFIX + "run - Receive response from invoice-service. [http.status.family="
	 ...
	 * 
	 * @param option
	 *            the given options 'delayInvoice', 'testInvoice'.
	 */
