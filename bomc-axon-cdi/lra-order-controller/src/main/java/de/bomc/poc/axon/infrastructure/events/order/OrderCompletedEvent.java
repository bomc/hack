...
public class OrderCompletedEvent {
	...
	private static final String LOG_PREFIX = "OrderCompletedEvent#";
	 ...
	 * @param productInfo
	 */
	public OrderCompletedEvent(final String orderId, final ProductInfo productInfo) {
	...
	public boolean equals(Object obj) {
		...
		final OrderCompletedEvent other = (OrderCompletedEvent) obj;
	...
	public String toString() {
		return "OrderCompletedEvent [orderId=" + this.orderId + ", productInfo=" + this.productInfo + "]";
	}
}
