...
/**
 * Provides the required infrastructure components as CDI-Producer.
 * 
...
public class AxonConfiguration implements Serializable {
	 ...
	 * The serial UID.
	 */
	private static final long serialVersionUID = 249765722243593337L;
	...
	@Produces
	@ApplicationScoped
	public EntityManagerProvider entityManagerProvider(final EntityManager entityManager) {
	...
	@Produces
	@ApplicationScoped
	public EventStorageEngine eventStorageEngine(final EntityManagerProvider entityManagerProvider,
