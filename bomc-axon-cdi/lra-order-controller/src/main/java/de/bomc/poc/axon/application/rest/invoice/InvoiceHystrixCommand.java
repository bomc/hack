...
/**
 * Create a invoice in invoice-service.
 * 
 * @author <a href="mailto:bomc@bomc.org">Michael Börner</a>
 * @version $Revision: $ $Author: $ $Date: $
 * @since 23.10.2018
 */
public class InvoiceHystrixCommand extends AbstractHystrixCommand<InvoiceHystrixResult> {

	private static final Logger LOGGER = Logger.getLogger(MethodHandles.lookup().lookupClass().getName());
	private static final String LOG_PREFIX = "InvoiceHystrixCommand#";
	private static final String SERVICE_NAME = "lra-invoice";
	private static final String BASE_URL = "http://127.0.0.1:8180/%s";
	private static final String API_PATH = "/rest/api/generate/";
	private String option;

	/**
	 * Creates a new instance of <code>InvoiceHytrixCommand</code>.
	 * 
	 */
	public InvoiceHystrixCommand() {
