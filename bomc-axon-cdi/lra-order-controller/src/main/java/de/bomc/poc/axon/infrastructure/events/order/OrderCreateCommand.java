...
public class OrderCreateCommand {
	...
	private static final String LOG_PREFIX = "OrderCreateCommand#";
	 ...
	 * @param productInfo
	 */
	public OrderCreateCommand(final String orderId, final ProductInfo productInfo) {
	...
	public boolean equals(Object obj) {
		...
		final OrderCreateCommand other = (OrderCreateCommand) obj;
	...
	public String toString() {
		return "OrderCreateCommand [orderId=" + this.orderId + ", productInfo=" + this.productInfo + "]";
	}
}
