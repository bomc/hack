 ...
 * @since 01.02.2018
 */
public class InvoiceHystrixResult {
	 ...
	 * @param successful
	 */
	public InvoiceHystrixResult(final String status, final boolean successful) {
		this.status = status;
	...
	public boolean equals(Object obj) {
		...
		final InvoiceHystrixResult other = (InvoiceHystrixResult) obj;
