...
interface DomainObject {
    ...
    /**
     * Returns the user who created this instance. This means the technical user as system and not a individual person.
     * @return the user.
     */
    String getCreateUser();

    /**
     * Set the user who created this instance. This means the technical user as system and not a individual person.
    ...
    /**
     * Returns the user who modified this instance. This means the technical user as system and not a individual person.
     * @return the user.
     */
    String getModifyUser();

    /**
     * Set the user who modified this instance. This means the technical user as system and not a individual person.
